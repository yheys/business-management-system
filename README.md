#  Yordi Printing — Business Management System

A fullstack web app built for a real printing and stationery shop to track daily transactions, expenses, income, and profit. Built with vanilla JavaScript, Node.js, Express, and SQLite.
